...
public class TestCompany implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        try {
            ...
            System.out.println();
            System.out.print("Successful coupon add for the logged-in company:");
            System.out.println();
            ...
            // Update coupon
            System.out.print("Successful coupon update for coupon number 8");
            System.out.println();
            System.out.print("Before:");
            try {
            ...
            // Delete coupon
            System.out.print("Successful coupon delete for coupon number 5");
            System.out.println();
            System.out.print("Before:");
            try {
                companiesImpl.getCompanyCoupons().forEach(System.out::println);
